    ...
    <nav class="navbar navbar-expand-sm fixed-top navbar-light navbar-dark js-scroll-trigger"
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse justify-content-end responsive" id="mynavbar">
                <ul class="navbar-nav text-white fs-6  ms-auto mb-2 mb-lg-0" style="letter-spacing: 1px;"
                    aria-labelledby="dropdownMenuButton1">
                    <li class="nav-item px-2">
                        <a class="nav-link js-scroll-trigger" href="foods.php">EXPLORE</a>
                    </li>
                    <li class="nav-item px-2">
...
<body class="js-scroll-trigger" style="background-color: #ac173a;">
    ...
    <section id="home" class="js-scroll-trigger">
        <div class="container-fluid top-banner">
            <div class="text-center fooodie">
                <a class="navbar-brand text-white js-scroll-trigger heading"
                    style="font-weight: 400;font-size: 80px; border: none;outline: none;"
                    data-bs-toggle="modal" data-bs-target="#myModal" href="#">Fooodie.!</a>
                    <p class="text-white text-center" style="font-weight:500; letter-spacing:2px">Good food choices are good investments</p>
            </div>
        </div>
        </div>
    </section>
    ...
    <section class="counter-section fixed-bottom" id="counter">
        <div class="container-fluid text-center" style="background-color: #ac173a;;color: white;padding: 8px 0 0 0;">
            <div class="row">
